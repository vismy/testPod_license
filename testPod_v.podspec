...
Pod::Spec.new do |s|
  ...
  s.description  = "testPod description"

  s.homepage     = "https://github.com/vismy/testPod"
 ...
 #  s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  ...
  s.author             = { "vismy" => "1141419686@qq.com" }
  ...
  s.source       = { :git => "https://github.com/vismy/testPod.git", :tag => "0.0.1" }
